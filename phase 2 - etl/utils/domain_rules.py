    ...
    domain_rules = {
        "Flights": {
            ...
            "consistency": [
                ...
                _fk_check("origin", "Stations", "airport"),
                _fk_check("dest", "Stations", "airport"),
                _fk_check("tail_num", "Aircrafts", "tail_num"),
                _fk_check("mkt_unique_carrier", "Carriers", "code"),
                _fk_check("op_unique_carrier", "Carriers", "code"),
                _fk_check("weather_observation_id", "Weather_Observations", "obs_id"),
        ...
        "Weather_Observations": {
            ...
            "consistency": [
                ...
                _fk_check("origin_airport", "Stations", "airport"),
